...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 281527071;
...
abstract class RustLibApi extends BaseApi {
  ...
  String crateApiMdMarkdow2HtmlSync({required String str});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  String crateApiMdMarkdow2HtmlSync({required String str}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiMdMarkdow2HtmlSyncConstMeta,
      argValues: [str],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMdMarkdow2HtmlSyncConstMeta => const TaskConstMeta(
        debugName: "markdow2html_sync",
        argNames: ["str"],
      );
